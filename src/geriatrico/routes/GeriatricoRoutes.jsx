...
import { AdminGeriatrico, AdminSuper, GeriatricoInactivoPage, GeriatricosPage, GestionarPersonas, GestionPersonaGeriatricoPage, HomePage, PacientesPage, ProfilePage, RolesPage, SedeEspecificaPage, SedesInactivoPage, SedesPage } from "../page";
...
export const GeriatricoRoutes = () => {
    return (
        <Routes>
            ...
            <Route path="adminGeriatrico" element={<AdminGeriatrico />} />
